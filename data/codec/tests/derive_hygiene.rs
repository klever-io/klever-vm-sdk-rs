...
// i.e. any types that are in scope and happen to have the same name as klever-sc-codec types do not break the build.
...
// Also adding all public functions exposed by klever-sc-codec.
