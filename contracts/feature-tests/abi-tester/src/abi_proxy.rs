    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn kda_token_payment(
        self,
    ) -> TxProxyCall<Env, From, To, Gas, KdaTokenPayment<Env::Api>> {
        self.wrapped_tx
            .raw_call("kda_token_payment")
            .original_result()
    }

    pub fn kda_token_data(
        self,
    ) -> TxProxyCall<Env, From, To, Gas, KdaTokenData<Env::Api>> {
        self.wrapped_tx
            .raw_call("kda_token_data")
            .original_result()
    }
