...
use klever_sc::types::Address;
use klever_sc_scenario::{
    managed_address, managed_biguint, managed_token_id, rust_biguint, testing_framework::*,
    DebugApi,
};

const CF_TOKEN_ID: &[u8] = b"CROWD-1234";
const CF_DEADLINE: u64 = 7 * 24 * 60 * 60; // 1 week in seconds
const WASM_PATH: &str = "output/crowdfunding-kda.wasm";
...
fn test_sc_error() {
    ...
    let mut expect = TxExpectMandos::new(57);
...
fn test_successful_cf() {
    ...
    b_wrapper.check_kda_balance(owner, CF_TOKEN_ID, &rust_biguint!(2_000));
    b_wrapper.check_kda_balance(first_user, CF_TOKEN_ID, &rust_biguint!(0));
    b_wrapper.check_kda_balance(second_user, CF_TOKEN_ID, &rust_biguint!(0));
}
