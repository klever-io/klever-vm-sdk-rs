...
fn field_snippet(index: usize, field: &syn::Field) -> proc_macro2::TokenStream {
    ...
    quote! {
        field_descriptions.push(klever_sc::abi::StructFieldDescription {
            docs: &[ #(#field_docs),* ],
            name: #field_name_str,
            ...
            quote! {
                fn provide_type_descriptions<TDC: klever_sc::abi::TypeDescriptionContainer>(accumulator: &mut TDC) {
                    ...
                    if !accumulator.contains_type(&type_name) {
                        ...
                        accumulator.insert(
                            type_name.clone(),
                            klever_sc::abi::TypeDescription {
                                docs: &[ #(#type_docs),* ],
                                name: type_name,
                                contents: klever_sc::abi::TypeContents::Struct(field_descriptions),
                            },
                        );
                    }
                }
            ...
            let enum_variant_snippets: Vec<proc_macro2::TokenStream> = data_enum
                ...
                .map(|(variant_index, variant)| {
                    ...
                    quote! {
                        ...
                        variant_descriptions.push(klever_sc::abi::EnumVariantDescription {
                            docs: &[ #(#variant_docs),* ],
                    ...
                    if !accumulator.contains_type(&type_name) {
                        ...
                        accumulator.insert(
                            ...
                            klever_sc::abi::TypeDescription {
                                docs: &[ #(#type_docs),* ],
                                name: type_name,
                                contents: klever_sc::abi::TypeContents::Enum(variant_descriptions),
                            },
                        );
                    }
                }
