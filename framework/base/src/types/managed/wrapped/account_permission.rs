...
#[derive(Clone, PartialEq, Eq, Debug, TypeAbi, NestedDecode, NestedEncode, TopEncode, TopDecode, ManagedVecItem)]
...
#[derive(ManagedVecItem, Debug, TopEncode, TopDecode, NestedEncode, NestedDecode, TypeAbi, Clone)]
