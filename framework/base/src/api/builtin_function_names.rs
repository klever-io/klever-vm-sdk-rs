...
pub const KDA_NFT_CREATE_FUNC_NAME: &str = "KDANFTCreate";
pub const KDA_NFT_ADD_QUANTITY_FUNC_NAME: &str = "KDANFTAddQuantity";
pub const KDA_NFT_ADD_URI_FUNC_NAME: &str = "KDANFTAddURI";
pub const KDA_NFT_UPDATE_ATTRIBUTES_FUNC_NAME: &str = "KDANFTUpdateAttributes";
pub const KDA_NFT_BURN_FUNC_NAME: &str = "KDANFTBurn";
