...
const PRELUDE: &str = "// Code generated by the klever-sc proxy generator. DO NOT EDIT.
...
const IMPORTS: &str = "use klever_sc::proxy_imports::*;";
...
where
    ...
    fn adjust_type_name_with_api(&mut self, original_rust_name: &str) -> String {
        self.clean_paths(
            &original_rust_name
                .replace("klever_sc::api::uncallable::UncallableApi", "Api")
                .replace("$API", "Api"),
        )
    }
...
#[cfg(test)]
pub mod tests {
    use klever_sc::abi::{BuildInfoAbi, ContractAbi, ContractCrateBuildAbi, FrameworkBuildAbi};
    ...
    fn clean_paths_unsanitized_test() {
        ...
        let original_contract_abi = ContractAbi::new(build_info, &[""], "contract-crate");
