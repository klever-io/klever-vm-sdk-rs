...
pub const LAST_VERSION: FrameworkVersion = framework_version!(0.43.3);
...
pub const LOWER_VERSION_WITH_AUTOGENERATED_JSON: FrameworkVersion = framework_version!(0.43.4);
pub const LOWER_VERSION_WITH_AUTOGENERATED_WASM: FrameworkVersion = framework_version!(0.43.4);
