...
pub const LAST_VERSION: &str = "0.43.3";
...
pub mod tests {
    ...
    fn template_versions_with_autogenerated_wasm_test() {
        assert_eq!(template_versions_with_autogenerated_wasm()[0], "0.43.4");

        assert!(is_template_with_autogenerated_wasm("0.43.4"));
        assert!(!is_template_with_autogenerated_wasm("0.43.3"));
    }

    #[test]
    fn template_versions_with_autogenerated_json_test() {
        assert_eq!(template_versions_with_autogenerated_json()[0], "0.43.4");

        assert!(is_template_with_autogenerated_json("0.43.4"));
