...
use klever_chain_scenario_format::interpret_trait::InterpreterContext;
use klever_sc::types::{ManagedAddress, ManagedBuffer, TxEnv, H256};
...
impl TxEnv for ScenarioTxEnvData {
    ...
    fn default_gas_annotation(&self) -> klever_sc::types::ManagedBuffer<Self::Api> {
