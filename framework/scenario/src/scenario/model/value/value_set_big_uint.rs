...
use crate::klever_sc::api::ManagedTypeApi;
...
impl<M: ManagedTypeApi> From<crate::klever_sc::types::BigUint<M>> for BigUintValue {
    fn from(from: crate::klever_sc::types::BigUint<M>) -> Self {
